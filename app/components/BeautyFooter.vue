...
<template>
  <!-- CTA section -->
  <footer
    class="relative w-full py-20 overflow-hidden border-t border-main-gray"
  >
    ...
    <div class="container mx-auto px-4 max-w-[1080px]">
      ...
      <div class="mt-12 pt-8 border-t border-main-gray">
        <div class="flex flex-col md:flex-row flex-wrap justify-between gap-6">
          <!-- Contact Information -->
          <div class="flex flex-col space-y-4">
            <div class="text-main-gray">
              <h3 class="text-lg font-bold mb-2 text-main-white2">
                Адрес
              </h3>
          ...
          <div class="flex flex-col">
            <h3 class="text-lg font-bold mb-4 text-main-white2">
              Социальные сети
            </h3>
